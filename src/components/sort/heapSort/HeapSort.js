...
class HeapSort extends React.Component {
  ...
  render() {
    ...
    heapTreeTop[5] = heapTreeArray[0], heapTreeRow2[2] = heapTreeArray[1], heapTreeRow2[8] = heapTreeArray[2], heapTreeRow3[1] = heapTreeArray[3], heapTreeRow3[3] = heapTreeArray[4];
    heapTreeRow3[7] = heapTreeArray[5], heapTreeRow3[9] = heapTreeArray[6], heapTreeRow4[0] = heapTreeArray[7], heapTreeRow4[1] = heapTreeArray[8], heapTreeRow4[3] = heapTreeArray[9];
