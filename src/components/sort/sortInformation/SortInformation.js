    ...
    return (
      <section className="sort-algorithm-info-section">
        ...
        <div className="sort-algorithm-details">
          ...
          <p className="complexity-detail" dangerouslySetInnerHTML={{__html: "Worst Case Performance " + sortAlgorithm.worstCase}}></p>
          <p className="complexity-detail" dangerouslySetInnerHTML={{__html: "Best Case Performance " + sortAlgorithm.bestCase}}></p>
          <p className="complexity-detail" dangerouslySetInnerHTML={{__html: "Average Case Performance " + sortAlgorithm.averageCase}}></p>
        </div>
