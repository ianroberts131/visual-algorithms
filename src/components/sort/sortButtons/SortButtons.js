  ...
  render() {
    ...
    if (isRunning && sortAlgorithm.name === 'Heap Sort') {
      heapSortTimeout = setTimeout (()=> {
        this.props.heapSort( sortArray, heapSortArray, iterations, heapTreeTop, heapTreeRow2, heapTreeRow3, heapTreeRow4, heapSortStep, smallHeapSortStep, startHeapTree, finishBuildHeap );
      }, intervalSpeed);
    }
