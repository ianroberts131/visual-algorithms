  ...
  render() {
    ...
    if (isRunning && sortAlgorithm.name === 'Heap Sort') {
      heapSortTimeout = setTimeout (()=> {
        this.props.heapSort( sortArray, heapSortArray, step2HeapSortArray, step3HeapSortArray, iterations, heapTreeTop, heapTreeRow2, heapTreeRow3, heapTreeRow4, heapTreeArray, heapSortStep, smallHeapSortStep, heapArrayIndex, startHeapTree, finishBuildHeap );
      }, intervalSpeed);
    }
